...
public class BaseServiceImpl<T, PK> implements BaseService<T, PK> {
    ...
    @Override
    public int deleteByProperty(Fn<T, ?> fn, Object value) {
        return myMapper.deleteByProperty(fn, value);
    }

    @Override
    public int deleteInByProperty(Fn<T, ?> fn, List<?> values) {
        return myMapper.deleteInByProperty(fn, values);
    }
